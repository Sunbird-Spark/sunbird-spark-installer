...
makeProperty('aiFeatures', String.class, Cardinality.LIST)
...
makeProperty('autoApproved', Boolean.class, Cardinality.SINGLE)
...
makeProperty('captionsUrl', String.class, Cardinality.SINGLE)
...
makeProperty('contentId', String.class, Cardinality.SINGLE)
...
makeProperty('errorMessage', String.class, Cardinality.SINGLE)
...
makeProperty('generatedBy', String.class, Cardinality.SINGLE)
makeProperty('generatedOn', String.class, Cardinality.SINGLE)
...
makeProperty('sourceLanguage', Boolean.class, Cardinality.SINGLE)
...
makeProperty('transcriptUrl', String.class, Cardinality.SINGLE)
makeProperty('transcripts', String.class, Cardinality.SINGLE)
